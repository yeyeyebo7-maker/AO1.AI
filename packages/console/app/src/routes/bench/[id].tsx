...
import { Database, eq } from "@ao1-ai/console-core/drizzle/index.js"
import { BenchmarkTable } from "@ao1-ai/console-core/schema/benchmark.sql.js"
                            ...
                            <td style={{ border: "1px solid #ccc", padding: "0.5rem" }}>
                              <For each={detail.judges}>
                                {(judge) => (
                                  ...
                                  >
                                    {judge.score === 1 ? "âœ“" : judge.score === 0 ? "âœ—" : judge.score}
                                  </span>
                                )}
                              </For>
                            </td>
                              ...
                              {(judge) => {
                                ...
                                return (
                                  <div style={{ "margin-top": "0.5rem", "padding-left": "1rem" }}>
                                    ...
                                    >
                                      <span style={{ "margin-right": "0.5rem" }}>{expanded() ? "â–¼" : "â–¶"}</span>
                                      <span
                                        style={{
                                          color: judge.score === 1 ? "green" : judge.score === 0 ? "red" : "inherit",
                                        }}
          ...
          {(() => {
            ...
            return (
              <div style={{ "margin-top": "1rem" }}>
                ...
                >
                  <span style={{ "margin-right": "0.5rem" }}>{jsonExpanded() ? "â–¼" : "â–¶"}</span>
