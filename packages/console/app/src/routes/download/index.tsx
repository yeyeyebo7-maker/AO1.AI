...
import desktopAppIcon from "../../asset/lander/ao1-desktop-icon.png"
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://ao1.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>ao1.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
