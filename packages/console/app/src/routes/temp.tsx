    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">ao1.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <footer data-component="footer">
          ...
          <div data-slot="cell">
            <a href="https://github.com/yeyeyebo7-maker/opencode">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://ao1.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
