...
import { and, Database, eq, isNull, lt, or, sql } from "@ao1-ai/console-core/drizzle/index.js"
import { KeyTable } from "@ao1-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@ao1-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@ao1-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@ao1-ai/console-core/util/date.js"
import { Identifier } from "@ao1-ai/console-core/identifier.js"
import { Billing } from "@ao1-ai/console-core/billing.js"
import { Actor } from "@ao1-ai/console-core/actor.js"
import { WorkspaceTable } from "@ao1-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@ao1-ai/console-core/model.js"
import { Subscription } from "@ao1-ai/console-core/subscription.js"
import { BlackData } from "@ao1-ai/console-core/black.js"
import { UserTable } from "@ao1-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@ao1-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@ao1-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@ao1-ai/console-core/lite.js"
...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://ao1.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://ao1.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://ao1.ai/workspace/${authInfo.workspaceID}/members`
