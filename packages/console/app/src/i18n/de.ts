...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | AO1",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "AO1 Logo hell",
  "notFound.logoDarkAlt": "AO1 Logo dunkel",
  ...
  "app.meta.description": "AO1 - Der Open-Source Coding-Agent.",

  "home.title": "AO1 | Der Open-Source AI-Coding-Agent",

  "temp.title": "AO1 | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von AO1",
  ...
  "temp.screenshot.caption": "AO1 TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "AO1 TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "AO1 Logo hell",
  "temp.logoDarkAlt": "AO1 Logo dunkel",
  ...
  "home.what.title": "Was ist AO1?",
  "home.what.body":
    "AO1 ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird AO1 von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "AO1 speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist AO1?",
  "home.faq.a1":
    "AO1 ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich AO1?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um AO1 zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, AO1 kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert AO1 auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit AO1 nutzen?",
  "home.faq.a4.p1":
    "Ja, AO1 unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich AO1 nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! AO1 ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet AO1?",
  "home.faq.a6":
    "AO1 ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist AO1 Open Source?",
  "home.faq.a8.p1": "Ja, AO1 ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die AO1 speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "AO1 Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die AO1 speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist AO1 Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter AO1.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann AO1 Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt AO1 nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit AO1 funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für AO1-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit AO1 zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "AO1 Go | Kostengünstige Coding-Modelle für alle",
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die AO1-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. AO1 Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit AO1 oder jedem Agenten nutzen.",
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du AO1 Go abonnierst - {{link}}",

  "black.meta.title": "AO1 Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit AO1 Black Abos.",
  ...
  "black.subscribe.success.title": "Du bist auf der AO1 Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit AO1, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle AO1",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte AO1 und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf AO1-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen AO1 Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast AO1 Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat AO1 Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat AO1 Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast AO1 Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "AO1 Go" als Anbieter in deiner opencode-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.black.message":
    "Du hast derzeit AO1 Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat AO1 Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "AO1 Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.title": "AO1 | Download",
  "download.meta.description": "Lade AO1 für macOS, Windows und Linux herunter",
  "download.hero.title": "AO1 herunterladen",
  ...
  "download.section.desktop": "AO1 Desktop (Beta)",
  "download.section.extensions": "AO1 Extensions",
  "download.section.integrations": "AO1 Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du AO1 mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert AO1 mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "AO1 ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während AO1 mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in AO1 erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "AO1 | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie AO1 für Enterprise-Lösungen",
  "enterprise.hero.title": "Ihr Code gehört Ihnen",
  "enterprise.hero.body1":
    "AO1 arbeitet sicher innerhalb Ihrer Organisation, ohne dass Daten oder Kontext gespeichert werden und ohne Lizenzbeschränkungen oder Eigentumsansprüche. Starten Sie einen Testlauf mit Ihrem Team, dann rollen Sie es in Ihrer Organisation aus, indem Sie es in Ihr SSO und internes AI-Gateway integrieren.",
  ...
  "enterprise.faq.q1": "Was ist AO1 Enterprise?",
  "enterprise.faq.a1":
    "AO1 Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit AO1 Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. AO1 speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit AO1 Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. AO1 speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "AO1 | Marke",
  "brand.meta.description": "AO1 Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der AO1-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "AO1 | Changelog",
  "changelog.meta.description": "AO1 Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für AO1",
