...
export const dict = {
  ...
  "app.meta.description": "AO1 — відкритий агент для програмування.",

  "home.title": "AO1 | Відкритий AI-агент для кодування",
  ...
  "temp.screenshot.caption": "AO1 TUI з темою tokyonight",
  "temp.screenshot.alt": "AO1 TUI з темою tokyonight",
  ...
  "home.what.title": "Що таке AO1?",
  "home.what.body": "AO1 — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, AO1 використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "AO1 не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке AO1?",
  "home.faq.a1":
    "AO1 — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися AO1?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання AO1?",
  "home.faq.a3.p1":
    "Не обов'язково, AO1 має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, AO1 також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з AO1?",
  "home.faq.a4.p1":
    "Так, AO1 підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати AO1 лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! AO1 тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує AO1?",
  "home.faq.a6":
    "AO1 є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є AO1 відкритим?",
  "home.faq.a8.p1": "Так, AO1 повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які AO1 протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "AO1 Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які AO1 протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке AO1 Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою AO1.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни AO1 може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, AO1 додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з AO1, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів AO1.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з AO1, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "AO1 Go | Недорогі моделі кодування для всіх",
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід AO1 доступним для якомога більшої кількості людей. AO1 Go — це недорога підписка: $5 за перший місяць, потім $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go починається від $5 за перший місяць, потім $10/місяць. Використовуйте з AO1 або будь-яким агентом.",
  ...
  "zen.api.error.trialEnded":
    "Безкоштовна акція для {{model}} закінчилася. Ви можете продовжити використання, підписавшись на AO1 Go — {{link}}",

  "black.meta.title": "AO1 Black | Доступ до найкращих моделей кодування",
  "black.meta.description": "Отримайте доступ до Claude, GPT, Gemini та інших із планами підписки AO1 Black.",
  "black.hero.title": "Доступ до найкращих моделей кодування",
  "black.hero.subtitle": "Включаючи Claude, GPT, Gemini та інші",
  "black.title": "AO1 Black | Ціни",
  ...
  "black.subscribe.success.title": "Ви в списку очікування AO1 Black",
  ...
  "workspace.black.subscription.message": "Ви підписані на AO1 Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план AO1 Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план AO1 Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на AO1 Go.",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "AO1 Go" як провайдера в конфігурації opencode.',
  "workspace.lite.black.message":
    "Ви вже підписані на AO1 Black або в списку очікування. Спочатку скасуйте підписку, якщо хочете перейти на Go.",
  "workspace.lite.other.message": "Інший учасник цього робочого простору вже підписаний на AO1 Go.",
  "workspace.lite.promo.description": "AO1 Go починається від {{price}}, потім $10/місяць, із щедрими лімітами.",
  ...
  "download.title": "AO1 | Завантажити",
  "download.meta.description": "Завантажте AO1 для macOS, Windows та Linux",
  "download.hero.title": "Завантажити AO1",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал AO1",
  "download.section.desktop": "Десктоп AO1 (Бета)",
  "download.section.extensions": "Розширення AO1",
  "download.section.integrations": "Інтеграції AO1",
  ...
  "download.faq.a3.afterZen":
    ", AO1 працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "AO1 є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в AO1.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "AO1 | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з AO1 для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "AO1 працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке AO1 Enterprise?",
  "enterprise.faq.a1":
    "AO1 Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з AO1 Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. AO1 за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з AO1 Enterprise?",
  "enterprise.faq.a4":
    "Так. AO1 не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "AO1 | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду AO1",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом AO1.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "AO1 | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін AO1",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення AO1",
