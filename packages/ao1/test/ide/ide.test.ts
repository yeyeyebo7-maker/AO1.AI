...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AO1_CALLER", () => {
    process.env["AO1_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AO1_CALLER", () => {
    process.env["AO1_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AO1_CALLER", () => {
    process.env["AO1_CALLER"] = "unknown"
