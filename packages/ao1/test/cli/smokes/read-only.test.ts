...
describe("opencode read-only commands (smoke)", () => {
  ...
  // AO1_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh AO1_TEST_HOME means
  ...
  // in production it'd be a path under AO1_TEST_HOME / XDG_DATA_HOME.
