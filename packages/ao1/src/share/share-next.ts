...
import type * as SDK from "@ao1-ai/sdk/v2"
...
import { SessionShareTable } from "@ao1-ai/core/share/sql"
import { ProviderV2 } from "@ao1-ai/core/provider"
import { ModelV2 } from "@ao1-ai/core/model"
import { EventV2 } from "@ao1-ai/core/event"

const disabled = process.env["AO1_DISABLE_SHARE"] === "true" || process.env["AO1_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/ShareNext") {}
