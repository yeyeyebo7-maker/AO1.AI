...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@ao1-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.ao1 || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@ao1/ToolRegistry") {}
