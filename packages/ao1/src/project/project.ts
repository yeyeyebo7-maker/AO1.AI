...
import { ProjectDirectoryTable, ProjectTable } from "@ao1-ai/core/project/sql"
...
import { which } from "@ao1-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AO1_FAKE_VCS)
