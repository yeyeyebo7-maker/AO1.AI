...
import { path } from "@ao1-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@ao1-ai/core/project"
...
import { WorktreeEvent } from "@ao1-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Worktree") {}
