...
export class Service extends Context.Service<Service, Interface>()("@ao1/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AO1_PHOTON_WASM_PATH?: string }).__AO1_PHOTON_WASM_PATH =
