...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@ao1/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@ao1/ACPDirectory") {}
