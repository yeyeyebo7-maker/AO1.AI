...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@ao1-ai/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/ACP/Service") {}
...
function fromUnknownError(error: unknown, service?: string): Error {
  ...
  return new ACPError.ServiceFailureError({ safeMessage: "AO1 service failure", service })
}
