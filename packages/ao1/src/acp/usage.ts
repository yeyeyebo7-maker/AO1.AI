...
import type { AssistantMessage as OpenCodeAssistantMessage, Message } from "@ao1-ai/sdk/v2"
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@ao1/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@ao1/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@ao1/ACPUsage") {}
