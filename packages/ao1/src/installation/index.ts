...
import { InstallationChannel, InstallationVersion } from "@ao1-ai/core/installation/version"
import { NpmConfig } from "@ao1-ai/core/npm-config"
import { InstallationEvent } from "@ao1-ai/schema/installation-event"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Installation") {}
  ...
  Effect.gen(function* () {
    ...
    const upgradeCurl = Effect.fnUntraced(
      function* (target: string) {
        const response = yield* httpOk.execute(HttpClientRequest.get("https://ao1.ai/install"))
    ...
    const result: Interface = {
      ...
      method: Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".ao1", "bin"))) return "curl" as Method
      ...
      latest: Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        const response = yield* httpOk.execute(
          HttpClientRequest.get("https://api.github.com/repos/yeyeyebo7-maker/opencode/releases/latest").pipe(
            HttpClientRequest.acceptJson,
          ),
        )
