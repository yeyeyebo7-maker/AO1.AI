...
import type { EventSource } from "@ao1-ai/tui/context/sdk"
import { writeHeapSnapshot } from "v8"
import { validateSession } from "../tui/validate-session"
import { win32InstallCtrlCGuard } from "@ao1-ai/tui/terminal-win32"

declare global {
  const AO1_WORKER_PATH: string
}
...
async function target() {
  if (typeof AO1_WORKER_PATH !== "undefined") return AO1_WORKER_PATH
