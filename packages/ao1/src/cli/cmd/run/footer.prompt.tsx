...
import { normalizePromptContent } from "@ao1-ai/tui/editor"
...
import { AO1_BASE_MODE, useBindings } from "@ao1-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close AO1" } satisfies SlashOption,
    ]
