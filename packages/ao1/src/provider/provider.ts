...
import { optional } from "@ao1-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@ao1-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Provider") {}
