...
import { WorkspaceEvent } from "@ao1-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AO1_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AO1_WORKSPACE_ID: config.id,
        AO1_EXPERIMENTAL_WORKSPACES: "true",
