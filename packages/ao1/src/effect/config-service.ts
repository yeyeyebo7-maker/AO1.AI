 ...
 *   "@ao1/ServerAuthConfig",
 *   {
 *     password: Config.string("AO1_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AO1_SERVER_USERNAME").pipe(Config.withDefault("ao1")),
 *   },
 * ) {}
 *
