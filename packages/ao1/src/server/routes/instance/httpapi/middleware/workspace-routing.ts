...
>()("@ao1/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@ao1/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AO1_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AO1_WORKSPACE_ID) : undefined
}
