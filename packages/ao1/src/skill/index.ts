...
import { FrontmatterError } from "@ao1-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@ao1-ai/core/util/glob"
...
const AO1_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const CUSTOMIZE_AO1_SKILL_NAME = "customize-opencode"
const CUSTOMIZE_AO1_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating opencode's own configuration: ao1.json, ao1.jsonc, files under .ao1/, or files under ~/.config/ao1/. Also use when creating or fixing opencode agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring opencode itself."
const CUSTOMIZE_AO1_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, AO1_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_AO1_SKILL_NAME] = {
          name: CUSTOMIZE_AO1_SKILL_NAME,
          description: CUSTOMIZE_AO1_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_AO1_SKILL_BODY,
        }
