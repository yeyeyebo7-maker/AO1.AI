import type { JsonSchema, LLMRequest, ProviderMetadata } from "@ao1-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@ao1-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @ao1-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
