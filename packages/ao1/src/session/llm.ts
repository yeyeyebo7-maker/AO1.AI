...
import { llmClient } from "@ao1-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@ao1-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@ao1-ai/llm/route"
import type { LLMClientService } from "@ao1-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @ao1-ai/llm. It
