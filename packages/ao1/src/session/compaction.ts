...
import { buildPrompt } from "@ao1-ai/core/session/compaction"
import { SessionCompactionEvent } from "@ao1-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/SessionCompaction") {}
