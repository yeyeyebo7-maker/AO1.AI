...
import { AbsolutePath, type DeepMutable } from "@ao1-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/Agent") {}
