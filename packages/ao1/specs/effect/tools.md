...
Practical reference for the current tool-migration state in `packages/ao1`.
...
Tool tests should use the existing Effect helpers in `packages/ao1/test/lib/effect.ts`:
