...
import defaultSoundPath from "@ao1-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@ao1-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@ao1-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@ao1-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@ao1-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@ao1-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "ao1"
const DEFAULT_PACK_ID = "ao1.default"
