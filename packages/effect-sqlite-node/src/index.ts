...
export const TypeId: TypeId = "~@ao1-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@ao1-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@ao1-ai/effect-sqlite-node/NodeSqliteClient")
