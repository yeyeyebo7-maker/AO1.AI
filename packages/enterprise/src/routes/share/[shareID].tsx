import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@ao1-ai/sdk/v2"
import { SessionTurn } from "@ao1-ai/session-ui/session-turn"
import { SessionReview } from "@ao1-ai/session-ui/session-review"
import { DataProvider } from "@ao1-ai/session-ui/context"
import { FileComponentProvider } from "@ao1-ai/ui/context/file"
import { WorkerPoolProvider } from "@ao1-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@ao1-ai/ui/logo"
import { IconButton } from "@ao1-ai/ui/icon-button"
import { ProviderIcon } from "@ao1-ai/ui/provider-icon"
import { iife } from "@ao1-ai/core/util/iife"
import { Binary } from "@ao1-ai/core/util/binary"
import { NamedError } from "@ao1-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@ao1-ai/ui/tabs"
import { MessageNav } from "@ao1-ai/session-ui/message-nav"
import { FileSSR } from "@ao1-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@ao1-ai/session-ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/yeyeyebo7-maker/opencode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
