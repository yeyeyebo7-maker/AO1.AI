...
import type { EffectDrizzleSqlite } from "@ao1-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/ProjectDirectories") {}
