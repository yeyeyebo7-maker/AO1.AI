...
import { Entry, FileSystem, FindInput, Match } from "@ao1-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@ao1-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/v2/FileSystem") {}
