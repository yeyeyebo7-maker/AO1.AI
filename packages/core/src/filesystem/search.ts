...
export class Service extends Context.Service<Service, Interface>()("@ao1/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.AO1_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
