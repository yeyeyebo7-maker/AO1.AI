...
import { FileSystemWatcher } from "@ao1-ai/schema/filesystem-watcher"
...
declare const AO1_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AO1_LIBC === "undefined" ? undefined : AO1_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@ao1/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AO1_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.AO1_EXPERIMENTAL_FILEWATCHER) {
