...
import { ToolFailure } from "@ao1-ai/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@ao1/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.AO1_WEBSEARCH_PROVIDER === "exa" || process.env.AO1_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.AO1_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("AO1_EXPERIMENTAL") || truthy("AO1_ENABLE_EXA") || truthy("AO1_EXPERIMENTAL_EXA"),
    enableParallel: truthy("AO1_ENABLE_PARALLEL") || truthy("AO1_EXPERIMENTAL_PARALLEL"),
