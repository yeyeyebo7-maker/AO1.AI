...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@ao1-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/v2/ToolRegistry") {}
