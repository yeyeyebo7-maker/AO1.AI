...
:::note
Dieses Tool ist nur verfuegbar, wenn `AO1_EXPERIMENTAL_LSP_TOOL=true` (oder `AO1_EXPERIMENTAL=true`) gesetzt ist.
:::
...
:::note
Dieses Tool ist nur verfuegbar, wenn der OpenCode-Provider genutzt wird oder die Umgebungsvariable `AO1_ENABLE_EXA` auf einen 'truthy' Wert (z. B. `true` oder `1`) gesetzt ist.
