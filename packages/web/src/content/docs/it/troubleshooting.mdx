...
Se hai `AO1_PORT` impostato nell'ambiente, l'app desktop provera a usare quella porta per il server locale.

- Rimuovi `AO1_PORT` (o scegli una porta libera) e riavvia.
