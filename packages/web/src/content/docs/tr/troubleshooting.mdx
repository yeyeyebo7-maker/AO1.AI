...
Ortamda `AO1_PORT` ayarliysa desktop uygulamasi yerel sunucu icin o portu kullanmaya calisir.

- `AO1_PORT` degerini kaldirin (veya bos bir port secin) ve yeniden baslatin
