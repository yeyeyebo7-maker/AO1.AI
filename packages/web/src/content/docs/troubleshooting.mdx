...
If you have `AO1_PORT` set in your environment, the desktop app will try to use that port for the local server.

- Unset `AO1_PORT` (or pick a free port) and restart.
