...
Da biste ga otvorili, koristite novog "AO1" agenta u AI Chat agent selektoru.
...
Ako trebate proslijediti varijable okruženja (kao što je `AO1_API_KEY`), pogledajte [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) u dokumentaciji CodeCompanion.nvim.
