export const dict = {
  ...
  "dialog.provider.ao1.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.ao1.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.ao1Go.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AO1",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AO1.",
  ...
  "provider.connect.ao1Zen.line1":
    "AO1 Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.ao1Zen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.ao1Zen.visit.prefix": "Odwiedź ",
  "provider.connect.ao1Zen.visit.link": "ao1.ai/zen",
  "provider.connect.ao1Zen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AO1.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AO1.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w ao1.json",
  ...
  "dialog.server.description": "Przełącz serwer AO1, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja AO1 ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AO1",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (ao1.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "AO1 zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AO1",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd AO1 na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AO1 ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AO1.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AO1",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AO1.",
