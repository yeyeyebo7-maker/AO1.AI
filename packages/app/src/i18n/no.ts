...
export const dict = {
  ...
  "dialog.provider.ao1.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.ao1.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.ao1Go.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AO1",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i AO1.",
  ...
  "provider.connect.ao1Zen.line1":
    "AO1 Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.ao1Zen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.ao1Zen.visit.prefix": "Besøk ",
  "provider.connect.ao1Zen.visit.link": "ao1.ai/zen",
  "provider.connect.ao1Zen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AO1.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AO1.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ao1.json",
  ...
  "dialog.server.description": "Bytt hvilken AO1-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AO1 ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AO1-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (ao1.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AO1 ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AO1 inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AO1-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AO1",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AO1 ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om AO1 skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan AO1 er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AO1 starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AO1.",
