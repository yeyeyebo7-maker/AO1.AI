...
export const dict = {
  ...
  "dialog.provider.ao1.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.ao1.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.ao1Go.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "AO1 tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AO1'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.ao1Zen.line1":
    "AO1 Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.ao1Zen.visit.prefix": "",
  "provider.connect.ao1Zen.visit.link": "ao1.ai/zen",
  "provider.connect.ao1Zen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve AO1'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AO1'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler ao1.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AO1 sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "AO1'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AO1 ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (ao1.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AO1 henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AO1 ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "AO1 sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AO1'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "AO1'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AO1'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AO1'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AO1 başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AO1'un en son sürümünü kullanıyorsunuz.",
