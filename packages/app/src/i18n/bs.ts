export const dict = {
  ...
  "dialog.provider.ao1.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.ao1.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.ao1Go.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AO1",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AO1-u.",
  ...
  "provider.connect.ao1Zen.line1":
    "AO1 Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.ao1Zen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.ao1Zen.visit.prefix": "Posjeti ",
  "provider.connect.ao1Zen.visit.link": "ao1.ai/zen",
  "provider.connect.ao1Zen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AO1-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AO1-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ao1.json",
  ...
  "dialog.server.description": "Promijeni na koji se AO1 server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija AO1-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AO1 timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (ao1.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AO1 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AO1 uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AO1 server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AO1-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako AO1 izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AO1 prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AO1-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AO1 pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AO1-a.",
