export const dict = {
  ...
  "dialog.provider.ao1.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.ao1.tagline": "Reliable optimized models",
  "dialog.provider.ao1Go.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AO1",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AO1.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.ao1Zen.line1":
    "AO1 Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.ao1Zen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.ao1Zen.visit.prefix": "Visit ",
  "provider.connect.ao1Zen.visit.link": "ao1.ai/zen",
  "provider.connect.ao1Zen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AO1.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AO1.",
  ...
  "dialog.plugins.empty": "Plugins configured in ao1.json",
  ...
  "dialog.server.description": "Switch which AO1 server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "AO1",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AO1...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AO1 in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AO1...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AO1 in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AO1 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AO1",
  "wsl.onboarding.opencodeReadyIn": "AO1 is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AO1 is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AO1 in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AO1",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AO1.",
  ...
  "toast.update.description": "A new version of AO1 ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AO1 team",
  ...
  "error.chain.checkConfig": "Check your config (ao1.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AO1 does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AO1 includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AO1 server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AO1",
  ...
  "settings.general.row.appearance.description": "Customise how AO1 looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AO1 follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AO1 is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AO1 launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AO1.",
