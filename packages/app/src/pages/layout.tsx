...
import { ResizeHandle } from "@ao1-ai/ui/resize-handle"
...
import { getFilename } from "@ao1-ai/core/util/path"
import { Session } from "@ao1-ai/sdk/v2/client"
...
import { toaster } from "@ao1-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@ao1-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://ao1.ai/desktop-feedback")}
      renderPanel={() =>
