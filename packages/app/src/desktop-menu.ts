...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "AO1 Documentation", href: "https://ao1.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/ao1" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/yeyeyebo7-maker/ao1/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/yeyeyebo7-maker/ao1/issues/new?template=bug_report.yml",
      },
    ],
  },
]
