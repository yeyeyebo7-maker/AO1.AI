...
import { Dialog, DialogBody, DialogHeader, DialogTitle } from "@ao1-ai/ui/v2/dialog-v2"
import { DividerV2 } from "@ao1-ai/ui/v2/divider-v2"
    ...
    <Show when={api}>
      <For each={props.servers()}>
        {(item) => {
          ...
          const check = () => wsl.data?.ao1Checks[item.config.distro]
