import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@ao1-ai/sdk/v2/client"
...
import { List, type ListRef } from "@ao1-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "ao1"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.ao1Zen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.ao1Zen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.ao1Zen.visit.prefix")}
                <Link href="https://ao1.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.ao1Zen.visit.link")}
                </Link>
                {language.t("provider.connect.ao1Zen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
