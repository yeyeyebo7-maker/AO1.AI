...
import { Tag } from "@ao1-ai/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "ao1", key: "dialog.provider.ao1.note" },
  { match: (id: string) => id === "ao1-go", key: "dialog.provider.ao1Go.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "ao1" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "ao1" || item.id === "ao1-go"}>
