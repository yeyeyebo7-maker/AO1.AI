...
import { SelectV2 } from "@ao1-ai/ui/v2/select-v2"
import { Switch } from "@ao1-ai/ui/v2/switch-v2"
import { TextInputV2 } from "@ao1-ai/ui/v2/text-input-v2"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_AO1_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://ao1.ai/docs/themes/">
