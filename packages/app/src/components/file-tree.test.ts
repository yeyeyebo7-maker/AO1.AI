...
beforeAll(async () => {
  ...
  mock.module("@ao1-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ao1-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ao1-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@ao1-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
