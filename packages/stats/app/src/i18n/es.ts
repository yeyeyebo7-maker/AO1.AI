export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | AO1 Data",
  "app.description":
    "Explora el uso de AO1 Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de AO1 Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a AO1 en GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Probar AO1",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de AO1 Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | AO1 Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en AO1 Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de AO1.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en AO1",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de AO1",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de AO1 durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | AO1 Data",
  "model.description":
    "Consulta datos de uso de {{model}} en AO1 Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de AO1 Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de AO1 Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de AO1 Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de AO1 Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de AO1 Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de AO1 Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de AO1 Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de AO1 Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de AO1 Go.",
  ...
  "model.geoDescription": "Tokens del modelo de AO1 Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de AO1 Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de AO1 Go.",
