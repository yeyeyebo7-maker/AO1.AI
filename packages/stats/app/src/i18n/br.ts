export const dict = {
  "app.title": "Ranking de uso de modelos de IA | AO1 Data",
  "app.description":
    "Explore o uso do AO1 Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do AO1 Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao AO1 no GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Experimente o AO1",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do AO1 Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | AO1 Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no AO1 Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do AO1.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no AO1",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do AO1",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do AO1 nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | AO1 Data",
  "model.description":
    "Veja dados de uso de {{model}} no AO1 Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no AO1 Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do AO1 Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do AO1 Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do AO1 Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do AO1 Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do AO1 Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do AO1 Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do AO1 Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do AO1 Go.",
  ...
  "model.geoDescription": "Tokens do modelo AO1 Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do AO1 Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do AO1 Go.",
