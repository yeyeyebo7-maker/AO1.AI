export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | AO1 Data",
  "app.description":
    "Explorez l'utilisation d'AO1 Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel AO1 Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à AO1 sur GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Essayer AO1",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'AO1 Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | AO1 Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans AO1 Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'AO1.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans AO1",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'AO1",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens AO1 sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | AO1 Data",
  "model.description":
    "Consultez les données d'utilisation AO1 Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation AO1 Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation AO1 Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation AO1 Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation AO1 Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens AO1 Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation AO1 Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens AO1 Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'AO1 Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions AO1 Go.",
  ...
  "model.geoDescription": "Tokens du modèle AO1 Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique AO1 Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens AO1 Go.",
