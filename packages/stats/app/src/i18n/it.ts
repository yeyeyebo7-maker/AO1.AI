export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | AO1 Data",
  "app.description":
    "Esplora l'utilizzo di AO1 Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo AO1 Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a AO1 su GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Prova AO1",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di AO1 Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | AO1 Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in AO1 Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di AO1.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in AO1",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di AO1",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token AO1 negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | AO1 Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in AO1 Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di AO1 Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo AO1 Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo AO1 Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di AO1 Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di AO1 Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di AO1 Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token AO1 Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di AO1 Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione AO1 Go.",
  ...
  "model.geoDescription": "Token del modello AO1 Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica AO1 Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token AO1 Go.",
