export const dict = {
  "app.title": "Rankingi użycia modeli AI | AO1 Data",
  "app.description":
    "Przeglądaj użycie AO1 Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny AO1 Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AO1 na GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Wypróbuj AO1",
  ...
  "footer.homeAria": "Strona główna AO1",
  ...
  "home.topModelsDescription": "Użycie modeli w AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AO1 Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AO1 Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w AO1 Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AO1.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AO1",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AO1",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AO1 z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AO1 Data",
  "model.description":
    "Zobacz dane użycia {{model}} w AO1 Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AO1 Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AO1 Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AO1 Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AO1 Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AO1 Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AO1 Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AO1 Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AO1 Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AO1 Go.",
  ...
  "model.geoDescription": "Tokeny modelu AO1 Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne AO1 Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AO1 Go.",
