export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AO1 Data",
  "app.description":
    "AO1 Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AO1 Data logosu",
  ...
  "header.githubAria": "GitHub'da AO1'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAO1": "AO1'u dene",
  ...
  "footer.homeAria": "AO1 ana sayfası",
  ...
  "home.topModelsDescription": "AO1 Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AO1 Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AO1 Data",
  "lab.description":
    "AO1 Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son AO1 kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AO1'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AO1 kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AO1 token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AO1 Data",
  "model.description":
    "{{model}} için AO1 Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AO1 Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki AO1 Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AO1 Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AO1 Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son AO1 Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AO1 Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AO1 Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AO1 Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AO1 Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan AO1 Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen AO1 Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son AO1 Go token hacmine göre yakındaki modeller.",
