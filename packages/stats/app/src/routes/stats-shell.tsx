...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/yeyeyebo7-maker/opencode",
  fallbackStars: "150K",
}
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://ao1.ai/">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://ao1.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://ao1.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@ao1.ai", label: i18n.t("footer.contact") },
    { href: "https://ao1.ai/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://ao1.ai" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
