...
const en = {
  "app.title": "AI Model Usage Rankings | AO1 Data",
  "app.description":
    "Explore AO1 Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "AO1 Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AO1 on GitHub",
  "header.github": "GitHub",
  "header.tryAO1": "Try AO1",
  ...
  "home.topModelsDescription": "Usage of models across AO1 Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique AO1 Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AO1 Data",
  "lab.description":
    "Compare {{lab}} models used in AO1 Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent AO1 usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AO1",
  ...
  "lab.shareOfUsage": "{{share}} of recent AO1 usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily AO1 token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AO1 Data",
  "model.description":
    "View {{model}} AO1 Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AO1 Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AO1 Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's AO1 Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AO1 Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent AO1 Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no AO1 Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily AO1 Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique AO1 Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average AO1 Go session shape.",
  ...
  "model.geoDescription": "AO1 Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No AO1 Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent AO1 Go token volume.",
