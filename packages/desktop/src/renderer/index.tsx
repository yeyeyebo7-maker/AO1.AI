...
import type { UpdaterState } from "@ao1-ai/app/updater"
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) =>
          i.name !== "Breadcrumbs" &&
          !(
            import.meta.env.AO1_CHANNEL === "prod" &&
...
const emitDeepLinks = (urls: string[]) => {
  ...
  window.__AO1__ ??= {}
  const pending = window.__AO1__.deepLinks ?? []
  window.__AO1__.deepLinks = [...pending, ...urls]
