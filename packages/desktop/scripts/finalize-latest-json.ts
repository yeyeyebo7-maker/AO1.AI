...
const releaseId = process.env.AO1_RELEASE
if (!releaseId) throw new Error("AO1_RELEASE is required")

const version = process.env.AO1_VERSION
if (!version) throw new Error("AO1_VERSION is required")
