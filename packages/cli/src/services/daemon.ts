...
import { createOpencodeClient } from "@ao1-ai/sdk/v2/client"
import { ServerAuth } from "@ao1-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@ao1/cli/Daemon") {}
