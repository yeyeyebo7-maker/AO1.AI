# Remove `packages/ao1/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/ao1/src/storage/db.ts` module.
...
Production imports from `packages/ao1/src/storage/db.ts` are concentrated in 22 source files:

- `packages/ao1/src/account/repo.ts`
- `packages/ao1/src/cli/cmd/db.ts`
- `packages/ao1/src/cli/cmd/import.ts`
- `packages/ao1/src/cli/cmd/stats.ts`
- `packages/ao1/src/control-plane/workspace.ts`
- `packages/ao1/src/index.ts`
- `packages/ao1/src/node.ts`
- `packages/ao1/src/permission/index.ts`
- `packages/ao1/src/project/project.ts`
- `packages/ao1/src/server/projectors.ts`
- `packages/ao1/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/ao1/src/server/shared/fence.ts`
- `packages/ao1/src/session/message-v2.ts`
- `packages/ao1/src/session/projectors.ts`
- `packages/ao1/src/session/prompt.ts`
- `packages/ao1/src/session/session.ts`
- `packages/ao1/src/session/todo.ts`
- `packages/ao1/src/share/share-next.ts`
- `packages/ao1/src/storage/db.ts`
- `packages/ao1/src/sync/index.ts`
- `packages/ao1/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/ao1/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/ao1/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/ao1`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/ao1/src`
- `bun typecheck` from `packages/ao1`
- Relevant package tests from `packages/ao1`, not the repo root
