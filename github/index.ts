...
import { createOpencodeClient } from "@ao1-ai/sdk"
...
function useShareUrl() {
  return isMock() ? "https://dev.ao1.ai" : "https://ao1.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.ao1.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.ao1.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
