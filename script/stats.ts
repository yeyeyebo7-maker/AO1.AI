...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/yeyeyebo7-maker/opencode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for yeyeyebo7-maker/opencode...\n")
